  ...
  const handleSignUp = (e) => {
    ...
    createUser(email, password)
      ...
      .then(data => {
        ...
        axiosSecure.post("/addUser", user).then((res) => console.log(res.data));
        // Update Profile
        manageProfile(name, photoURL).then().catch();
        navigate("/");
      })
      .catch((error) => {
      ...
      <div className="grid grid-cols-2 gap-20 justify-between items-center h-[100vh]  ">
        ...
        <div className=" bg-white m-8 ">
          ...
          <div className="w-52 mx-auto mb-3">
            <Link to="/">
              <img src="https://i.ibb.co/gMVVZXK/Logo.png" className="w-52" />
            </Link>
          </div>
          ...
          <div className="border-[1px] border-gray-200 rounded-lg p-8">
            ...
            <form
              ...
              className="mt-8 mb-2 md:w-full sm:w-96"
            >
